  ...
  return (
    <div className="border-b border-white/5 last:border-0">
      ...
      >
        ...
        <ChevronDown className={`w-5 h-5 transition-transform duration-300 ${isOpen ? 'rotate-180 text-purple-500' : 'text-gray-600'}`} />
      </button>
      <AnimatePresence>
        {isOpen && (
          <motion.div 
...
const LiveSearchDemo = ({ lang }: { lang: 'ar' | 'en' }) => {
  ...
  // تعريف الأنواع بشكل صريح لحل مشكلة TypeScript
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      const list = (demoData[lang][key] || [])
        .sort((a: any, b: any) => a.price - b.price); // ترتيب حسب السعر
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
        ...
        >
          {isSearching ? (
            <><Loader2 className="w-5 h-5 animate-spin" />{tx.searching}</>
          ) : (
            <><Search className="w-5 h-5" />{tx.button}</>
          )}
        </button>
                ...
                >
                  <div className="flex items-center justify-between gap-4 flex-row-reverse">
                    <div className="flex-1 text-right">
                      <h4 className="font-bold text-lg mb-1">{result.name}</h4>
                      <div className="flex items-center gap-4 justify-end text-sm text-gray-400 flex-wrap">
                        <span className="flex items-center gap-1">
                          <MapPin className="w-4 h-4" />{result.distance}
                        </span>
                        <span className="flex items-center gap-1">
                          <Star className="w-4 h-4 fill-yellow-500 text-yellow-500" />{result.rating}
                        </span>
    ...
    <section className="py-24 px-6 bg-[#030014] border-y border-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 font-medium text-xl">{t[lang].subtitle}</p>
        </motion.div>

        <div className="relative max-w-3xl mx-auto">
          {/* خريطة السعودية المبسطة */}
          <motion.div
            ...
            {(lang === 'ar'
              ...
              <div key={i} className="flex items-center gap-3">
                <div className="flex flex-col items-center gap-2">
                  <div className="w-14 h-14 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-2xl hover:bg-white/10 transition-all">
                    {step.emoji}
                  </div>
                  <span className="text-xs text-gray-500 font-bold">{step.text}</span>
                </div>
                {i < arr.length - 1 && (
                  <div className="hidden sm:block text-gray-700 text-xl mb-5">
                    {lang === 'ar' ? '←' : '→'}
                  </div>
                )}
              </div>
...
export default function KhidmaAIV2() {
  ...
  const [cookieVisible, setCookieVisible] = useState(true); // ← هنا
  ...
  return (
    <div ref={containerRef} className={`min-h-screen bg-[#02000f] text-white selection:bg-purple-500/30 font-sans overflow-x-hidden ${isRTL ? 'text-right' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'} style={{ fontFamily: '"Tajawal", "Cairo", sans-serif' }}>
      ...
      {/* --- Navigation --- */}
      <nav className={`fixed top-0 w-full z-50 border-b border-white/5 transition-all duration-300 ${scrolled ? 'bg-[#02000f]/95 backdrop-blur-2xl shadow-lg shadow-purple-500/5' : 'bg-[#02000f]/80 backdrop-blur-xl'}`}>
            ...
            >
              <div className="px-6 py-4 space-y-4">
                ...
                <div className="pt-4 border-t border-white/5 space-y-3">
                  ...
                  <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-full font-bold">
                    {content.nav.login}
                  </button>
                </div>
              </div>
      ...
      <section className="relative pt-40 pb-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`${isRTL ? 'text-right' : 'text-left'} z-10`}>
            ...
            >
              <Globe className="w-3 h-3" /> {content.hero.webNotice}
            </motion.div>
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-blue-600 rounded-[3rem] blur opacity-20 animate-pulse"></div>
            <PhoneMockup />
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-purple-600/20 blur-[140px] -z-10 rounded-full" />
      </section>

      {/* --- شريط البراندات المتحرك --- */}
      <div className="py-10 border-y border-white/5 bg-white/[0.01] overflow-hidden group">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 md:gap-12 text-center">
            {[
              ...
              <motion.div 
                ...
                transition={{ delay: i * 0.1 }}
              >
                <div className="flex items-center justify-center gap-2 text-purple-500 mb-2 opacity-60 group-hover:opacity-100 transition-opacity">
                  {stat.icon}
                </div>
      ...
      <section id="business" className="py-32 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className={`text-center mb-20`}>
            ...
            >
              <Rocket className="w-4 h-4" /> {lang === 'ar' ? 'حلول احترافية لأصحاب الأعمال' : 'Professional Solutions for Business Owners'}
            </motion.div>
          ...
          >
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-gradient-to-r from-purple-600/10 to-blue-600/10 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
              ...
              <a   onClick={handleContact} className="px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl font-black text-lg hover:shadow-2xl hover:shadow-purple-500/30 transition-all flex items-center gap-2 group">
      ...
      <section id="features" className="py-24 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-xl">{content.features.subtitle}</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[600px]">
            ...
            >
              <div className={`relative z-10 ${isRTL ? 'text-right' : 'text-left'}`}>
                <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md group-hover:scale-110 transition-transform">
              ...
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-purple-500/20 blur-3xl rounded-full group-hover:scale-150 transition-transform duration-700" />
            </motion.div>
            ...
            >
              <div className="flex-1">
                ...
                <p className={`text-gray-500 font-medium`}>{content.features.ratings.desc}</p>
              </div>
              <div className="hidden sm:flex w-32 h-32 bg-yellow-500/10 rounded-full border border-yellow-500/20 items-center justify-center text-4xl">
                👌
              </div>
            </motion.div>
            ...
            >
              <Navigation className="w-12 h-12 text-blue-400 mb-4 group-hover:animate-bounce" />
      ...
      <section className="py-24 px-6 bg-[#030014] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-lg">{content.trust.subtitle}</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {content.trust.items.map((item, i) => (
              ...
              >
                <div className="w-14 h-14 mx-auto mb-4 bg-gradient-to-br from-purple-500/20 to-blue-500/20 rounded-2xl flex items-center justify-center text-purple-400 group-hover:scale-110 transition-transform">
                  {item.icon}
                </div>
      ...
      <section id="testimonials" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-xl">{content.testimonials.subtitle}</p>
          </motion.div>
      ...
      <section className="py-24 px-6 bg-[#030014] border-y border-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-500 font-medium text-lg">{content.platforms.subtitle}</p>
          </motion.div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-blue-600 blur-[80px] opacity-20 group-hover:opacity-30 transition-opacity" />
                ...
                >
                  <div className={`flex items-center justify-between mb-6 border-b border-white/5 pb-4 ${isRTL ? 'flex-row-reverse' : ''}`}>
                    <div className={`flex items-center gap-2 ${isRTL ? 'flex-row-reverse' : ''}`}>
                      <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-xs font-bold relative">
                        AI
      ...
      <section id="faq" className={`py-24 px-6 max-w-4xl mx-auto`}>
        ...
        >
          ...
          <p className="text-gray-500 font-medium text-xl">{content.faq.subtitle}</p>
        </motion.div>
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
...
<section className="py-24 px-6">
  ...
  >
    ...
    <motion.div animate={{ scale: [1,1.2,1], opacity: [0.3,0.5,0.3] }} transition={{ duration: 4, repeat: Infinity }} className="absolute top-0 right-0 w-64 h-64 bg-purple-400 rounded-full blur-3xl" />
    <motion.div animate={{ scale: [1.2,1,1.2], opacity: [0.3,0.5,0.3] }} transition={{ duration: 5, repeat: Infinity }} className="absolute bottom-0 left-0 w-64 h-64 bg-blue-400 rounded-full blur-3xl" />
    ...
    <div className="relative z-10">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        >
          ...
          <ArrowRight className={`w-6 h-6 group-hover:translate-x-1 transition-transform ${lang === 'ar' ? 'rotate-180' : ''}`} />
        </button>
      ...
      {/* --- Footer --- */}
      <footer className={`py-20 border-t border-white/5 relative overflow-hidden ${isRTL ? 'text-right' : 'text-left'}`}>
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className={`flex flex-col md:flex-row justify-between items-start md:items-center gap-10 ${isRTL ? 'md:flex-row-reverse' : ''}`}>
            <div>
              ...
              <p className="text-gray-500 max-w-xs font-bold leading-relaxed mb-6">
                {content.footer.desc}
              </p>
              
              {/* Social Links */}
              <div className="flex items-center gap-4">
                <a href="https://tiktok.com/@khidmaai" target="_blank" rel="noopener noreferrer"  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-purple-500/30 transition-all group">
                  <FaTiktok className="w-5 h-5 group-hover:text-purple-400 transition-colors" />
                </a>
                <a href="https://instagram.com/khidmaai" target="_blank" rel="noopener noreferrer"  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-purple-500/30 transition-all group">
                  <FaInstagram className="w-5 h-5 group-hover:text-purple-400 transition-colors" />
                </a>
                <a href="khidmaai51718@gmail.com" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-purple-500/30 transition-all group">
            ...
            <div className={`flex flex-wrap gap-16 ${isRTL ? 'flex-row-reverse text-right' : 'text-left'}`}>
              ...
              <div className="space-y-4">
                ...
                <ul className="text-gray-500 space-y-2 text-sm font-bold">
                   <li>
                      <a href="https://tiktok.com/@khidmaai" target="_blank" className="hover:text-purple-400 transition-colors">{content.footer.twitter}</a></li>
                      <li>
                        <a href="https://instagram.com/khidmaai" target="_blank" className="hover:text-purple-400 transition-color">{content.footer.instagram}</a></li>
                        <li>
                          <a href="mailto:khidmaai51718@gmail.com" className="hover:text-purple-400 transition-colors">{content.footer.email}</a></li>
                          </ul>
              </div>
            </div>
          </div>
          ...
          <div className={`mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold text-gray-600 tracking-widest uppercase ${isRTL ? 'md:flex-row-reverse' : ''}`}>
            ...
            <span onClick={() => window.location.href = '/privacy'} className="hover:text-purple-400 cursor-pointer transition-colors">{content.footer.privacy}
            </span>             
            <span onClick={() => window.location.href = '/terms'} className="hover:text-purple-400 cursor-pointer transition-colors">{content.footer.terms}
            </span>
            </div>
          </div>
        </div>
